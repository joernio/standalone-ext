...
cannot be evaluated and cannot be passed as an argument in function calls.""")
  ...
  def mynodetype: Iterator[nodes.Mynodetype] = wrappedCpg.graph._nodes(32).asInstanceOf[Iterator[nodes.Mynodetype]]
...
first loading of the CPG.""")
  def namespace: Iterator[nodes.Namespace] = wrappedCpg.graph._nodes(33).asInstanceOf[Iterator[nodes.Namespace]]
...
`foo.bar` denotes the namespace `bar` contained in the namespace `foo`.""")
  def namespaceBlock: Iterator[nodes.NamespaceBlock] =
    wrappedCpg.graph._nodes(34).asInstanceOf[Iterator[nodes.NamespaceBlock]]
...
represented via `METHOD_RETURN` nodes.""")
  def ret: Iterator[nodes.Return] = wrappedCpg.graph._nodes(35).asInstanceOf[Iterator[nodes.Return]]
  ...
  def tag: Iterator[nodes.Tag] = wrappedCpg.graph._nodes(36).asInstanceOf[Iterator[nodes.Tag]]
  ...
  def tagNodePair: Iterator[nodes.TagNodePair] = wrappedCpg.graph._nodes(37).asInstanceOf[Iterator[nodes.TagNodePair]]
  ...
  def templateDom: Iterator[nodes.TemplateDom] = wrappedCpg.graph._nodes(38).asInstanceOf[Iterator[nodes.TemplateDom]]
...
of a type declaration.""")
  def typ: Iterator[nodes.Type] = wrappedCpg.graph._nodes(39).asInstanceOf[Iterator[nodes.Type]]
...
`CODE` field.""")
  def typeArgument: Iterator[nodes.TypeArgument] =
    wrappedCpg.graph._nodes(40).asInstanceOf[Iterator[nodes.TypeArgument]]
...
and its type is indicated in the `AST_PARENT_TYPE` field to be one of
`METHOD`, `TYPE_DECL` or `NAMESPACE_BLOCK`.""")
  def typeDecl: Iterator[nodes.TypeDecl] = wrappedCpg.graph._nodes(41).asInstanceOf[Iterator[nodes.TypeDecl]]
...
parameter carries only a `NAME` field that holds the parameters name.""")
  def typeParameter: Iterator[nodes.TypeParameter] =
    wrappedCpg.graph._nodes(42).asInstanceOf[Iterator[nodes.TypeParameter]]

  /** Reference to a type/class */
  @flatgraph.help.Doc(info = """Reference to a type/class""")
  def typeRef: Iterator[nodes.TypeRef] = wrappedCpg.graph._nodes(43).asInstanceOf[Iterator[nodes.TypeRef]]
...
included using a node of type `UNKNOWN`.""")
  def unknown: Iterator[nodes.Unknown] = wrappedCpg.graph._nodes(44).asInstanceOf[Iterator[nodes.Unknown]]
