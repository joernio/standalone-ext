...
class NewTagNodePair extends NewNode(37.toShort) with TagNodePairBase {
  ...
  override def flattenProperties(interface: flatgraph.BatchedUpdateInterface): Unit = {
    interface.insertProperty(this, 58, Iterator(this.node))
    interface.insertProperty(this, 59, Iterator(this.tag))
  }
