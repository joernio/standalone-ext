...
class NewUnknown extends NewNode(44.toShort) with UnknownBase with ExpressionNew {
  ...
  override def flattenProperties(interface: flatgraph.BatchedUpdateInterface): Unit = {
    ...
    interface.insertProperty(this, 47, Iterator(this.parserTypeName))
    if (possibleTypes.nonEmpty) interface.insertProperty(this, 48, this.possibleTypes)
    interface.insertProperty(this, 53, Iterator(this.typeFullName))
  }
