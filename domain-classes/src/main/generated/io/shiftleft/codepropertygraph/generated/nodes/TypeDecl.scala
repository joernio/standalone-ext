...
class NewTypeDecl extends NewNode(41.toShort) with TypeDeclBase with AstNodeNew {
  ...
  override def flattenProperties(interface: flatgraph.BatchedUpdateInterface): Unit = {
    ...
    if (offset.nonEmpty) interface.insertProperty(this, 42, this.offset)
    if (offsetEnd.nonEmpty) interface.insertProperty(this, 43, this.offsetEnd)
