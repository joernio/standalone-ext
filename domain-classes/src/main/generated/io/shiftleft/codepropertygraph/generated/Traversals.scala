...
object Accessors {
  ...
  final class Traversal_Property_MYPROPERTY[NodeType <: nodes.StoredNode & nodes.StaticType[nodes.HasMypropertyEMT]](
    val traversal: Iterator[NodeType]
  ) extends AnyVal {
  ...
  final class Traversal_MynodetypeBase[NodeType <: nodes.MynodetypeBase](val traversal: Iterator[NodeType])
      extends AnyVal {
...
trait ConcreteStoredConversions extends ConcreteBaseConversions {
  ...
  ](traversal: IterableOnce[NodeType]): Traversal_Property_MYPROPERTY[NodeType] = new Traversal_Property_MYPROPERTY(
    traversal.iterator
  )
...
trait ConcreteBaseConversions extends AbstractBaseConversions0 {
  ...
  implicit def traversal_MynodetypeBase[NodeType <: nodes.MynodetypeBase](
    traversal: IterableOnce[NodeType]
  ): Traversal_MynodetypeBase[NodeType] = new Traversal_MynodetypeBase(traversal.iterator)
